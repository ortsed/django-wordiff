...
# If defined in settings, ADDITIONAL_STOPWORDS is a list of words to be added to the stopwords list
if hasattr(settings, "WORDIFF_ADDITIONAL_STOPWORDS"):
	stopwords_new.append(settings.ADDITIONAL_STOPWORDS)
